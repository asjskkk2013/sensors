...
#define uint8_t unsigned char   //定义uint8_t
#define int16_t int             //定义int16_t
#define uint32_t unsigned long  //定义uint32_t
...
uint8_t MPU6050_GetDeviceID(void);       //读取器件ID
//读出mpu6050的三轴传感器、温度和三轴陀螺仪数据
